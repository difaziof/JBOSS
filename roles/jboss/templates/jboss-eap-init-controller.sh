...
JBOSS_CONF={{jboss_home}}/jboss-eap/jboss.conf.d/jboss-{{ansible_hostname}}.conf
...
if [ -z "$JBOSS_HOME" ]; then
        JBOSS_HOME=/data/jboss/jboss-eap
fi
export JBOSS_HOME

if [ -z "$JBOSS_PIDFILE" ]; then
        JBOSS_PIDFILE=$JBOSS_HOME/$JBOSS_BASE_DIR/pid/jboss-{{ansible_hostname}}.pid
fi
...
if [ -z "$JBOSS_LOCKFILE" ]; then
        JBOSS_LOCKFILE={{jboss_home}}/jboss-eap
fi
