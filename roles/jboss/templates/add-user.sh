...
if [ $JBOSS_BASE_DIR == "master" ];then
JAVA_OPTS="$JAVA_OPTS -Djboss.server.config.user.dir=../{{ansible_hostname}}/configuration -Djboss.domain.config.user.dir=../master/configuration"
else
JAVA_OPTS="$JAVA_OPTS -Djboss.server.config.user.dir=../{{ansible_hostname}}/configuration"
fi
